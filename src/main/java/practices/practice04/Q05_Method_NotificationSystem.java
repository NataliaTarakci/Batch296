...
public class Q05_Method_NotificationSystem {
     ...
     */
        public static void main(String[] args) {
                ...
                String emailResult = sendNotification("natalia@mail.com", "Order.", "Out of delivery.");
                System.out.println("emailResult = " + emailResult);

                String smsResult = sendNotification(123456L, "Out of delivery");
                System.out.println("smsResult = " + smsResult);

                String pushResult = sendNotification("Don't miss order");
                System.out.println("pushResult = " + pushResult);

        }


        public static String sendNotification(String email, String subject, String message){
                return "Email notification sent to this email: " + email + " with subject: " + subject + " and message: " + message;
        }

        public static String sendNotification(long phoneNumber, String message){
                return "SMS notification sent to this phone number: " + phoneNumber + " with message: " + message;
        }

        public static String sendNotification(String message){
                return "Push notification sent with this message: " + message;
        }

...
public class Q04_ArrayList_Playlist {
    ...
    public static void main(String[] args) {
        ...
        musicList.add("Song A");
        musicList.add("Song B");
        musicList.add("Song C");
        musicList.add("Song D");
        musicList.add("Song E");
        musicList.add("Song F");
        musicList.add("Song G");
        ...
        System.out.println("numOfRotations = " + numOfRotations);
        if (numOfRotations!=0){
            ArrayList<String> tempList = new ArrayList<>();
            for (int i = 0; i < numOfRotations; i++) {
                tempList.add(musicList.get(i));
            }
            for (int i = numOfRotations; i < size; i++) {
                musicList.set(i-numOfRotations, musicList.get(i));
            }
            System.out.println("shifted musicList = " + musicList);
            for (int i = 0; i < numOfRotations; i++) {
                musicList.set(size-numOfRotations+i, tempList.get(i));
            }
            System.out.println("Playlist after rotation: " + musicList);
        }

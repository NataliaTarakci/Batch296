...
public class Set02 {
    ...
    public static void main(String[] args) {
        ...
        // retainAll() method keeps the data in first set which is common in the second set
        // lhs =  [23, 3, 11, 6, 8]
        // lhs2 = [3, 50, 65, 89, 6]
...
//        System.out.println("ts = " + ts); // NullPointerException
        ...
        SortedSet<Character>  ts1 =  ts.subSet('D', 'O'); // starting value is inclusive, ending value is exclusive

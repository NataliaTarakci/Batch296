...
public class HW {
    ...
    public static void main(String[] args) {
        ...
        int[][] arr2 = {{1, 2, 3}, {2, 4, 5}, {3, 5, 6}}; // The array is symmetric
        //int[][] arr2 = {{1, 0, 3}, {2, 4, 5}, {3, 5, 6}}; // The array is not symmetric


        int numOfColumns= 0;
        int numOfRows= arr2.length;

        for (int[] eachArray : arr2){
            numOfColumns= eachArray.length;
        }

        int notMatchedPairs = 0;
        ...
        if (notMatchedPairs==0 && numOfRows==numOfColumns){

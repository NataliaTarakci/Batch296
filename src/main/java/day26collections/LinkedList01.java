...
//        Object list5 = new LinkedList<>(); //This also works
        ...
        // Example 2: If the number of characters in the given name is less than 7, remove them from the list.
        // Don't use for-each loop

        List<String> russianNames = new ArrayList<>();
        russianNames.add("Anna");
        russianNames.add("Anastasiya");
        russianNames.add("Katya");
        russianNames.add("Natalya");
        russianNames.add("Polina");
        russianNames.add("Ekaterina");
        russianNames.add("Elizaveta");
        russianNames.add("Julia");
        System.out.println("Russian Names = " + russianNames);
        for (int i = 0; i < russianNames.size(); i++) {
            if (russianNames.get(i).length()<7){
                russianNames.remove(russianNames.get(i));
                i--;
            }
        }
        System.out.println("Russian Names more than 7 = " + russianNames);
